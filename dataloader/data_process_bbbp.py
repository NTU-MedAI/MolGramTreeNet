...
class MolGraphDataset():
    def __init__(self, path):
        ...
        self.target_names = self.header_cols[2:3, -1]
        self.smiles_1 = np.genfromtxt(path, delimiter=',', skip_header=1, usecols=[3], dtype=np.str_, comments=None)
        self.targets_1 = np.genfromtxt(path, delimiter=',', skip_header=1, usecols=[2], dtype=np.int_, comments=None)
